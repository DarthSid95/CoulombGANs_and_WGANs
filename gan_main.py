...
flags.DEFINE_string('topic', 'RBFCoulombGAN', """Base, RBFCoulombGAN""")
flags.DEFINE_string('data', 'g2', """Type of Data to run for - g2, gmm8""")
flags.DEFINE_string('gan', 'WGAN', """Type of GAN for""")
flags.DEFINE_string('loss', 'RBF', """Type of Loss function to use - RBF for RBFCoulombGAN""")
...
flags.DEFINE_string('arch', 'nodense', """nodense (lin transform) vs dense""")

# ''' Flags for RBFCoulombGAN RBF'''
